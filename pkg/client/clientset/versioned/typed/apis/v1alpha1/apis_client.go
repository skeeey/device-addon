...
import (
	...
	"github.com/skeeey/device-addon/pkg/client/clientset/versioned/scheme"
...
func (c *EdgeV1alpha1Client) DeviceDataModels() DeviceDataModelInterface {
	return newDeviceDataModels(c)
}
