...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceDataModelList":      schema_device_addon_pkg_apis_v1alpha1_DeviceDataModelList(ref),
		"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceDataModelReference": schema_device_addon_pkg_apis_v1alpha1_DeviceDataModelReference(ref),
		"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceDataModelSpec":      schema_device_addon_pkg_apis_v1alpha1_DeviceDataModelSpec(ref),
		...
		"github.com/skeeey/device-addon/pkg/apis/v1alpha1.ReportedAttr":             schema_device_addon_pkg_apis_v1alpha1_ReportedAttr(ref),
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Attribute describes an individual device attribute.",
				Type:        []string{"object"},
...
func schema_device_addon_pkg_apis_v1alpha1_Device(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceSpec", "github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_device_addon_pkg_apis_v1alpha1_DeviceData(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_device_addon_pkg_apis_v1alpha1_DeviceDataModel(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "DeviceDataModel specifies the device data schema.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "spec holds the data schema of a device.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceDataModelSpec"),
						},
					},
				},
				Required: []string{"metadata", "spec"},
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceDataModelSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_device_addon_pkg_apis_v1alpha1_DeviceDataModelList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "DeviceDataModelList is a list of DeviceDataModel",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceDataModel"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceDataModel", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_device_addon_pkg_apis_v1alpha1_DeviceDataModelReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_device_addon_pkg_apis_v1alpha1_DeviceDataModelSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.Attribute"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.Attribute"},
	}
}
...
func schema_device_addon_pkg_apis_v1alpha1_DeviceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.Device"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.Device", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_device_addon_pkg_apis_v1alpha1_DeviceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.ReportedAttr"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.ReportedAttr", "k8s.io/apimachinery/pkg/apis/meta/v1.Condition"},
	}
}

func schema_device_addon_pkg_apis_v1alpha1_ReportedAttr(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"lastUpdatedTime": {
						SchemaProps: spec.SchemaProps{
							Description: "lastUpdatedTime is the last updated time for this attribute.",
							Default:     map[string]interface{}{},
