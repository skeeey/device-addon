...
func schema_device_addon_pkg_apis_v1alpha1_DeviceAddOnConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceAddOnConfigSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceAddOnConfigSpecStatus"),
						},
					},
				},
				Required: []string{"metadata", "spec"},
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceAddOnConfigSpec", "github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceAddOnConfigSpecStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_device_addon_pkg_apis_v1alpha1_DeviceAddOnConfigList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceAddOnConfig"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceAddOnConfig", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_device_addon_pkg_apis_v1alpha1_DeviceConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceProfile", "github.com/skeeey/device-addon/pkg/apis/v1alpha1.Values"},
	}
}
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/skeeey/device-addon/pkg/apis/v1alpha1.DeviceResource"),
									},
								},
							},
						},
...
func schema_device_addon_pkg_apis_v1alpha1_DeviceResource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/skeeey/device-addon/pkg/apis/v1alpha1.ResourceProperties", "github.com/skeeey/device-addon/pkg/apis/v1alpha1.Values"},
	}
}
